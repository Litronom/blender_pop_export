...
def export_pop_data(context, self, filepath, course_pop, main_curve, bezier_curves, child_curves):
    ...
    filename_without_extension = re.sub(r'\.OK64\.POP3$', '', filename_with_extension)
    section_name = "path"
    ...
    show_message_box("Pop3 data exported to file", "Finished", 'INFO')
    return {'FINISHED'}
